...
function swaggerFactory(
    ...
    function swaggerValidator() {
        ...
        namespace = '/api/2.0/nodeconfig/definitions/';
        schemaPath = path.resolve(__dirname, '../../static/schemas/nodeconfig');
        var namespace4Added = schemaApiService.addNamespace(schemaPath, namespace);

        var namespacesAdded = Promise.all([namespace1Added, namespace2Added, namespace3Added, namespace4Added]);
